...
kable(model.sel(lm9, lm10, lm11,null, lm12, rank = AIC), caption = "Table 1: *AIC for models*")
```

```{r, include = FALSE}
table <- kable(anova(lm9, lm10, lm11, lm12,null), caption = "Table 2: *ANOVA for models*")
```
